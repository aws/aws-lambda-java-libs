...
import com.amazonaws.services.lambda.runtime.api.client.Functions.R0;
import com.amazonaws.services.lambda.runtime.api.client.Functions.R1;
import com.amazonaws.services.lambda.runtime.api.client.Functions.R2;
import com.amazonaws.services.lambda.runtime.api.client.Functions.R3;
import com.amazonaws.services.lambda.runtime.api.client.Functions.R4;
import com.amazonaws.services.lambda.runtime.api.client.Functions.R5;
import com.amazonaws.services.lambda.runtime.api.client.Functions.R9;
import com.amazonaws.services.lambda.runtime.api.client.Functions.V1;
...
final class ReflectUtil {
    ...
    /**
     * Copy a class from one class loader to another. Was previously used in
     * AwsJackson class to do some crazy
     * passing of classes from class loader to class loader. When that class was
     * removed due to excessive complexity,
    ...
    public static Class<?> copyClass(Class<?> clazz, ClassLoader cl) {
        ...
        try {
            R5<Class<?>, ClassLoader, String, byte[], Integer, Integer> defineClassMethod = ReflectUtil.loadInstanceR4(
                    ClassLoader.class, "defineClass", true,
                    (Class<Class<?>>) (Class) Class.class, String.class, byte[].class, int.class, int.class);
            Class<?> result = defineClassMethod.call(cl, clazz.getName(), stream.getRawBuf(), 0,
                    stream.getValidByteCount());
            V2<ClassLoader, Class<?>> resolveClass = ReflectUtil.loadInstanceV1(ClassLoader.class, "resolveClass", true,
                    Class.class);
    ...
    private static <T> Constructor<? extends T> getDeclaredConstructor(Class<? extends T> clazz, boolean setAccessible,
            Class<?>... pTypes) {
    ...
    public static <A1, A2, A3, A4, C, R> R5<R, C, A1, A2, A3, A4> loadInstanceR4(Class<? super C> clazz,
        ...
        final Method method = getDeclaredMethod(clazz, name, false, setAccessible, rType, a1Type, a2Type, a3Type,
                a4Type);
     ...
     * @return function handle
     */
    public static <C, A1, A2, A3> R3<C, A1, A2, A3> loadConstuctor3(final Class<? extends C> clazz,
            boolean setAccessible,
            Class<? super A1> a1Type, Class<? super A2> a2Type,
            Class<? super A3> a3Type) {
        final Constructor<? extends C> constructor = getDeclaredConstructor(clazz, setAccessible, a1Type, a2Type,
    ...
    public static <C, A1, A2, A3, A4, A5, A6, A7, A8, A9> R9<C, A1, A2, A3, A4, A5, A6, A7, A8, A9> loadConstuctor9(
        ...
        final Constructor<? extends C> constructor = getDeclaredConstructor(clazz, setAccessible, a1Type, a2Type,
                a3Type, a4Type, a5Type, a6Type, a7Type, a8Type, a9type);
